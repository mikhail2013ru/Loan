...
window.addEventListener('DOMContentLoaded', () => {
  ...
  new _modules_download__WEBPACK_IMPORTED_MODULE_5__["default"]('.download').init();
...
class Download {
  ...
  downloadItem(path) {
    ...
    element.click();
    document.body.replaceChild(element);
  }
  init() {
...
class MiniSlider extends _slider__WEBPACK_IMPORTED_MODULE_1__["default"] {
  ...
  decorizeSlides() {
    [...this.slides].forEach(slide => {
      // console.log(slide.classList.remove(this.activeClass));
